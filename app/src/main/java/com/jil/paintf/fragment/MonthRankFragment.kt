 ...
 * Use the [MonthRankFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MonthRankFragment : LazyFragment() {
    ...
    override fun onCreateView(
        ...
        return initView(inflater, container, R.layout.fragment_month_rank)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment MonthRankFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: Int) =
            MonthRankFragment().apply {
