...
class WeekRankFragment : LazyFragment() {
    ...
    override fun onCreateView(
        ...
        return initView(inflater, container, R.layout.fragment_week_rank)
    }
